...
namespace FinalProject.Controllers
{
    public class ClaimsController : Controller
    {
        ...
        public ClaimsController(saulBarrasDatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var saulBarrasDatabaseContext = _context.Claims.Include(c => c.Vehicle);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'saulBarrasDatabaseContext.Claims'  is null.");
            }
            var claim = await _context.Claims.FindAsync(id);
            if (claim != null)
            {
