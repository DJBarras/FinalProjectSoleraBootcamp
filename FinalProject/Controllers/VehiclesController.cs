...
namespace FinalProject.Controllers
{
    ...
    {
        private readonly saulBarrasDatabaseContext _context;

        public VehiclesController(saulBarrasDatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var saulBarrasDatabaseContext = _context.Vehicles.Include(v => v.Owner);
            return View(await saulBarrasDatabaseContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'saulBarrasDatabaseContext.Vehicles'  is null.");
            }
            var vehicle = await _context.Vehicles.FindAsync(id);
            if (vehicle != null)
            {
